...
public class StickerView extends FrameLayout {
    ...
    public void configDefaultIcons() {
        BitmapStickerIcon deleteIcon = new BitmapStickerIcon(
                ContextCompat.getDrawable(getContext(), R.drawable.ic_weightlifter),
   ...
   // TODO: Sample
    ...
    public void rotateSticker(@NonNull Sticker sticker, @NonNull MotionEvent event) {
        if (sticker != null) {
    ...
    // TODO: Original-Method for rotate and zoom
